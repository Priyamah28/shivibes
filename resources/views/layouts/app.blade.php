    ...
    <footer class="mt-16 border-t border-brand-100 bg-white">
        <div class="section-container grid gap-10 py-12 md:grid-cols-2 lg:grid-cols-4">
            <div>
                ...
                <a href="https://wa.me/919000000000" target="_blank" rel="noopener" class="mt-4 inline-flex items-center gap-2 text-sm font-semibold text-brand-700 hover:text-brand-800">

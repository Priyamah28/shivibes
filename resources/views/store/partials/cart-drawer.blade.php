<div x-data="cartDrawer" @toggle-cart.window="toggle()" class="relative z-50">
    ...
    >
        <div class="flex items-center justify-between border-b border-brand-100 px-6 py-4">
            ...
            <button @click="open = false" class="rounded-full p-2 hover:bg-brand-50">✕</button>
        </div>
        ...
        <div class="flex-1 overflow-y-auto px-6 py-4">
            ...
            <template x-if="!loading && items.length === 0">
                <div class="py-12 text-center">
                    ...
                    <a href="{{ route('products.index') }}" class="btn-primary mt-4 inline-flex">Continue Shopping</a>
                </div>
            </template>
